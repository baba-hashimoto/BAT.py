...
set filini prep-lig-ini.pdb
set filpdb prep-lig.pdb
set filpsf prep-lig.psf

set all [atomselect top all]
$all set chain A
set a [atomselect top "resname LIG and noh"]
set tot [$a get name]
set n 0
set z 100
set zmax 100
...
foreach i $tot {
set t [atomselect top "resname LIG and name $i"]
set p [atomselect top "protein and resid 58 and name CA"]
...
set m [atomselect top "resname LIG and name $aa1"]
set p [atomselect top "protein resid 58 and name CA"]
...
set pr [atomselect top "(protein and resid 4 to 112 and not water and not resname LIG and noh) or (resname LIG)"]
...
mol delete all
mol load pdb $filpdb
set a [atomselect top "resname LIG and name $aa1"]
$a moveby {0 0 -5}
$a writepdb dum1.pdb
mol delete all
...
set b [atomselect 4 "protein and resid 58 and name CA"]
set c [atomselect 4 "resname LIG and name $aa1"]
...
set lig [atomselect 7 "resname LIG"]
set ligh [atomselect 7 "resname LIG and noh"]
$lig set chain S
$lig set resid 1
...
set b [atomselect 10 "protein and resid 58 and name CA"]
set c [atomselect 10 "resname LIG and name $aa1"]
set d1 [vecsub [measure center $b weight mass] [measure center $c weight mass]]
set d2 [lindex $d1 2]
set dlis [list 0 0 [expr -$d2-5]]
$b moveby $dlis
...
set angle3 {}
set angle {}
set t [atomselect 17 "resname LIG and name $i"]
set p [atomselect 17 "resname LIG and name $aa1"]
...
set angle3 {}
set angle {}
set t [atomselect 21 "resname LIG and name $i"]
set p [atomselect 21 "resname LIG and name $aa2"]
set d [atomselect 21 "resname LIG and name $aa1"]
